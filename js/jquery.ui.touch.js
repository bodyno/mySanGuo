     ...
     $.fn.lyhucTouchPad = function(options) {
		...
		*/
		...
		return this.each(function(){
				...
				obj.bind("ontouchstart",function(e){
					point.X = e.pageX;
					point.Y = e.pageY;
					
				}).bind("ontouchmove",endDrag);
				
				$(touchPageWrapper).bind("outouchstart",startDrag)
				.bind("click",clearEvent)
				.bind("ontouchmove",endDrag).bind("ontouchend",endDrag);
